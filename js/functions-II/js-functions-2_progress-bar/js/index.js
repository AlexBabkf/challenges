...
function calculateScrollPercentage() {
  let perc =
    (100 * (window.scrollY + window.innerHeight)) / document.body.clientHeight;
  // console.log(perc);
  // console.log(`${perc}%`);
  return perc;
}
...
document.addEventListener("scroll", () => {
  progressBar.style.width = parseInt(calculateScrollPercentage()) + "%";
  console.log(progressBar.style.width);
});
console.log(parseInt(calculateScrollPercentage()) + "%");
